...
Seule la faction principale (V1) est autorisée à participer aux événements PvP. Les factions secondaires (V2, V3, etc.) sont formellement interdites en event et se feront disqualifié. 
...
Cibler une faction précise uniquement pour **nuire à son classement** sans jouer l'objectif est interdit et prendra directement une disqualification pour hard focus de 2 jours.
...
- La POV doit couvrir l'intégralité du cassage du Totem, du tick 0 jusqu'à la destruction de chaque bloc ( le rec doit être visible sans aucun bug).
...
Tout logiciel ou modification technique visant à **altérer le gameplay de base, à tricher ou à obtenir un avantage déloyal** est interdit et se verra sanctionner.
...
| Exploitation de Failles / anti jeu | Sanction variable en fonction de la gravité des faits ainsi que -10% des points |
...
| Crossteam avéré | Perte de 15% des points de CHAQUE faction impliquée + ban 1j des joueurs impliqués pour anti jeu |
