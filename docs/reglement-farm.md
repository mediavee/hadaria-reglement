...
Il est **interdit de rester sur le toit d'une base** pendant un tournoi.
Vous pouvez cependant utiliser des moyens actifs pour piller une base, comme des canons ou des creepers.
Toute tentative de contournement (piller uniquement pendant les tournois dans le but d'exploiter cette règle) sera sanctionnée par un bannissement.
...
**Contournement des protections de farm**

Toute tentative ou réussite de contournement d'une protection de farm (captcha, jail, etc.) sera passible d'un **blacklist**.
Cela inclut toute action visant à éviter ou désactiver ces mesures de sécurité mises en place pour encadrer le farm.
