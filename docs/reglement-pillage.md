...
## Règlement – Triche, Bugs, Exploits & Raids
...
- Si un **pillage** est entamé avant la fin des **48h**, le délai est prolongé à **96h** pour permettre de finaliser les actions. Au terme de ce délai, le claim doit être rendu s'il n'y a plus **aucune action active**.
- Tout abus de cette règle peut entraîner des **pénalités** en jeu, voire des **bannissements temporaires** selon la gravité.
...
**Respecter l'ensemble de ces règles est primordial pour maintenir une expérience de jeu équitable et agréable pour tous. Toute violation sera sanctionnée conformément aux dispositions prévues.**
